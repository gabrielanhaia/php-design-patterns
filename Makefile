...
help:
		...
		@echo "   ${COLOR_COMMENT}# make${COLOR_RESET} ${COLOR_INFO}composite${COLOR_RESET}"
		...
		@echo "   ${COLOR_COMMENT}# make${COLOR_RESET} ${COLOR_INFO}iterator${COLOR_RESET}"
		...
		@echo "   ${COLOR_COMMENT}# make${COLOR_RESET} ${COLOR_INFO}interpreter${COLOR_RESET}"
